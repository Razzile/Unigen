...
static const char *type_names[] = {
    ...
    "float",  // R4
    "double", // R8
    "String",   "Ptr",           "REF",      "ValueType", "Class",
    "var",      "array",         "Generic",  "TypedREF",
    "int",  // I
    "uint", // U
    "FuncPtr",  "Object",        "sArray",   "mvar",      "cmod_reqd",
    "cmod_opt", "internal_type", "modifier", "sentinel",  "pinned",
    "enum"};
...
public:
  MetadataObject(MemoryStream *metadata, Binary *binary)
      : stream_(metadata), binary_(binary){};
  bool Parse();
...
protected:
  ...
  GenericContainerFromIndex(GenericContainerIndex index); // metadata header
