...
public:
  Binary(MemoryStream *stream)
      : stream_(stream), metadata_registration_(0x0), code_registration_(0x0) {}
  Binary(MemoryStream *stream, uintptr_t mReg, uintptr_t cReg)
      : stream_(stream), metadata_registration_(mReg),
        code_registration_(cReg) {}
